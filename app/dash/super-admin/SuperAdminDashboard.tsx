    ...
    <main className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
      <header className="mb-10 flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            href="/dash/super-admin/chat"
            className="rounded-xl border border-violet-400/30 bg-violet-950/30 px-4 py-2 text-sm font-medium text-violet-100 hover:bg-violet-900/30"
          >
            Chat admin
          </Link>
          <Link
