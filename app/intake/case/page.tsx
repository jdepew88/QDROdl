  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mb-6 text-zinc-300">
        Court and key dates only. Party details and plan-specific questions come
        next.
      </p>
      ...
      <div className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-5">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/15 bg-zinc-900 p-3 text-stone-50"
              value={caseInfo.dom}
              onChange={(e) => onChange("dom", e.target.value)}
            />
          </div>
          <div>
            <label className="mb-1 block text-xs text-zinc-400">
        ...
        <label className="inline-flex items-center gap-2 text-sm text-zinc-300">
          <input
            ...
            onChange={(e) =>
              onChange("concurrentWithJudgment", e.target.checked)
            }
          />
