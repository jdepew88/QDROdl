...
function DistributionMethods() {
  const methods = [
    ...
    },
    {
      ...
      specialContent: {
        title: "Independent Deferred Compensation Account",
        description:
          "Alternate payee becomes a plan participant with their own account\nCan make independent investment and distribution elections",
      },
      requirements: "Plan must allow for separate account maintenance:",
      requirementDetail:
