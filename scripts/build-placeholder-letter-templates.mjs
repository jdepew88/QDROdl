...
const review = [
  ...
  "{{letter.date_today}}",
  "",
  "Re: Case No. {{caseInfo.number}} — {{court.county}} — preliminary review of draft DRO/QDRO",
  "",
...
const closeout = [
  ...
  "{{letter.date_today}}",
  "",
  "Re: Case No. {{caseInfo.number}} — service of court-filed order on plan administrator",
  "",
  "Petitioner: {{party.petitioner.full_name}}",
  "Respondent: {{party.respondent.full_name}}",
  "",
